...
copy_scripts() {
  ...
  cp "/vagrant/control/activate.xml" "${initrd}/scripts/"
  cp "/vagrant/control/rearm.xml" "${initrd}/scripts/"
  cp "/vagrant/control/boot.xml" "${initrd}/scripts/"
  cp "/vagrant/control/boot.bat" "${initrd}/scripts/"
